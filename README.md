...
Статический сайт-каталог **7 992 языков мира**: поиск, фильтры, сортируемая
таблица, интерактивная карта и карточка каждого языка со ссылками на
грамматики, словари, записи речи и учебные материалы.
...
|---|---|---|
| [Glottolog](https://glottolog.org) (glottolog-cldf) | языки, семьи, координаты, страны, статус AES, MED | CC BY 4.0 |
| [Wikidata](https://www.wikidata.org) | число носителей (P1098), русские названия, ссылки на Википедию | CC0 |
